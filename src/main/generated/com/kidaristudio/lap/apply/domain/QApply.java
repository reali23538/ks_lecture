...
public class QApply extends EntityPathBase<Apply> {
    ...
    private static final long serialVersionUID = 957589488L;
    ...
    public final com.kidaristudio.lap.lecture.domain.QLecture lecture;
    ...
    public QApply(Class<? extends Apply> type, PathMetadata metadata, PathInits inits) {
        ...
        this.lecture = inits.isInitialized("lecture") ? new com.kidaristudio.lap.lecture.domain.QLecture(forProperty("lecture")) : null;
    }
